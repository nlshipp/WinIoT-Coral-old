#
# NXP iMX8M Quad Phanbell board description
#
# The board is iMX8M with 1GB DRAM
#
...
################################################################################
[Defines]
  DEFINE BOARD_NAME       = MCIMX8M_PHANBELL_1GB
...
!endif
  ...
  # uSDHCx | iMX8M Phanbell Connections
  #-------------------------------------
  # uSDHC1 | eMMC
  # uSDHC2 | SD Card slot
  # uSDHC3 | N/A
  ...
  #
  # PCIe Device Config Space : 0x1FF00000 - 0x1FF80000
  ...
  # by the boot loader is as below
  #
  # PCIe Device Config Space : 0x27F00000 - 0x27F80000
  # PCIe Device Memory Space : 0x20000000 - 0x27EFFFFF
  giMX8TokenSpaceGuid.PcdPcie2Enable|TRUE
  giMX8TokenSpaceGuid.PcdPcie2ControlBaseAddress|0x33C00000
  giMX8TokenSpaceGuid.PcdPcie2DeviceMemoryBase|0x20000000
  giMX8TokenSpaceGuid.PcdPcie2DeviceMemorySize|0x07F00000
