...
class PlatformBuilder(UefiBuilder):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("ACTIVE_PLATFORM", "NXP/MCIMX8M_PHANBELL_1GB/MCIMX8M_PHANBELL_1GB.dsc", "Platform Hardcoded")
        self.env.SetValue("PRODUCT_NAME", "MCIMX8M_PHANBELL_1GB", "Platform Hardcoded")
    ...
    def SetPlatformEnvAfterTarget(self):
        ...
        self.env.SetValue("BUILD_OUTPUT_BASE", value, "Computed in MCIMX8M_PHANBELL_1GB Build")

        # Output FD file
        key = "OUTPUT_FD"
        value = os.path.join(self.env.GetValue("BUILD_OUTPUT_BASE"), "FV", "ClientBios.fd")
        self.env.SetValue(key, value, "Computed in MCIMX8M_PHANBELL_1GB Build")
