...
#define PCIE1_DEVICE_CONFIG_BASE_REG     FixedPcdGet64(PcdPcie1DeviceConfigBase)
#define PCIE1_DEVICE_CONFIG_SIZE         FixedPcdGet64(PcdPcie1DeviceConfigSize)
...
#define PCIE2_DEVICE_CONFIG_BASE_REG     FixedPcdGet64(PcdPcie2DeviceConfigBase)
#define PCIE2_DEVICE_CONFIG_SIZE         FixedPcdGet64(PcdPcie2DeviceConfigSize)
